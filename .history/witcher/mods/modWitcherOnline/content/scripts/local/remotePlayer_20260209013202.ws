...
statemachine class r_RemotePlayer 
{
    ...
    public function CheckInvites()
    {
        ...
        {
            // Generic Debug to confirm chat sync works
            // theGame.GetGuiManager().ShowNotification("DEBUG: Chat: " + lastChat);
        }
        ...
        if(StrLen(lastChat) > 7)
        {
            ...
            {
                // DEBUG
                theGame.GetGuiManager().ShowNotification("DEBUG: INVITE RECEIVED: " + lastChat);
                ...
                if(idx1 > -1)
                {
                    ...
                    // DEBUG
                    theGame.GetGuiManager().ShowNotification("Target: " + inviteTarget + " Local: " + theGame.r_getMultiplayerClient().getUsername());
