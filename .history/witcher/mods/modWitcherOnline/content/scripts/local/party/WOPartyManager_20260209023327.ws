...
class WOPartyManager
{
    ...
    public function ReceiveInvite(sender : string, pName : string)
    {
        if(IsInParty())
        {
            ...
            // Auto-decline and notify sender
            theGame.r_getMultiplayerClient().setChat("#DECLINE:" + sender + ":Already in a party");
            theGame.r_getMultiplayerClient().setLastChatTime(theGame.GetEngineTimeAsSeconds());
    ...
    public function GetPendingInviteSender() : string
    {
        return pendingInviteSender;
    }

    public function GetPendingInviteParty() : string
    {
